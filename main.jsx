    ...
    <div style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', minHeight: '100vh', color: 'white', padding: '20px', fontFamily: 'sans-serif' }}>
      ...
      {currentSong ? (
        <div style={{ textAlign: 'center', marginTop: '40px' }}>
          ...
          <button onClick={() => setShowLyrics(!showLyrics)} style={{ marginTop: '20px', background: 'rgba(255,255,255,0.2)', border: 'none', padding: '10px 20px', borderRadius: '20px', color: 'white' }}>
        ...
        <div>
          ...
          {queue.map((s, i) => (
            <div key={i} onClick={() => playSong(s, i)} style={{ background: 'rgba(255,255,255,0.1)', margin: '10px 0', padding: '15px', borderRadius: '10px', cursor: 'pointer' }}>
